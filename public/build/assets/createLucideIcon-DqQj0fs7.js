import{Z as v,$ as a,p as A}from"./app-BKujZfJx.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=({name:t,iconNode:e,absoluteStrokeWidth:r,"absolute-stroke-width":o,strokeWidth:c,"stroke-width":k,size:i,color:p,...C},{slots:l})=>{const{size:n,color:f,strokeWidth:m=2,absoluteStrokeWidth:g=!1,class:x=""}=j(),b=A(()=>{const u=h(r)||h(o)||r===!0||o===!0||g===!0,d=c||k||m||s["stroke-width"];return u?Number(d)*24/Number(i??n??s.width):d});return a("svg",{...s,...C,width:i??n??s.width,height:i??n??s.height,stroke:p??f??s.stroke,"stroke-width":b.value,class:S("lucide",x,...t?[`lucide-${w(W(t))}-icon`,`lucide-${w(t)}`]:["lucide-icon"])},[...e.map(u=>a(...u)),...l.default?[l.default()]:[]])};/**
 * @license @lucide/vue v1.21.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
