        ...
        return Inertia::render('Admin/Settings/Edit', [
            'settings' => [
                ...$settings->only([
                    ...
                    'auth_page_subtitle', 'auth_login_title', 'auth_register_title',
                    'auth_login_subtitle', 'auth_register_subtitle',
                    'catalog_information_heading', 'catalog_information_items',
                ]),
