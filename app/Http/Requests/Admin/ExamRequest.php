...
abstract class ExamRequest extends FormRequest
{
    ...
    final public function rules(): array
    {
        return [
            ...
            'questions.*.options' => ['required', 'array', 'min:4', 'max:5'],
    ...
    final public function messages(): array
    {
        return [
            ...
            'questions.*.options.required' => 'Au moins 4 options sont requises.',
            'questions.*.options.min' => 'Au moins 4 options sont requises.',
