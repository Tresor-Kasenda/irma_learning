<div class="min-h-screen bg-gray-50" x-data="{ activeTab: 'dashboard' }">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8 xl:max-w-7xl mx-auto py-8 sm:py-12">
            ...
            <div class="mt-8 flex space-x-4">
                <button @click="activeTab = 'dashboard'"
                    :class="{ 'bg-white text-primary-700 shadow-lg': activeTab === 'dashboard', 'bg-primary-800/30 text-white hover:bg-primary-800/50': activeTab !== 'dashboard' }"
                ...
                <button @click="activeTab = 'settings'"
                    :class="{ 'bg-white text-primary-700 shadow-lg': activeTab === 'settings', 'bg-primary-800/30 text-white hover:bg-primary-800/50': activeTab !== 'settings' }"
                    class="px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-4 sm:px-6 lg:px-8 xl:max-w-7xl mx-auto py-8 space-y-8">
        ...
        {{-- SETTINGS TAB --}}
        <div x-show="activeTab === 'settings'" class="space-y-8" x-cloak>
