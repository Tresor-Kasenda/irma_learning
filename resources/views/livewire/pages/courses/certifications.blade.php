            ...
            <div class="w-full grid items-center relative pt-4">
                <div
                    ...
                    <div class="relative max-w-lg lg:max-w-none space-y-7 flex flex-col w-full lg:w-1/2 lg:flex-1">
                        <div
                            class=" text-sm pt-8 text-fg-subtitle flex items-center justify-center divide-x divide-fg/50 *:px-4 first:*:pl-0 last:*:pr-0 overflow-hidden max-w-full">
                            ...
                            <div class="text-fg-subtext text-center">
                                Certification
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col p-4 xl:p-5 justify-between min-h-full">
                                ...
                                <ul
                                    ...
                                    @foreach ($formations as $formation)
                                        <li class="flex-1 flex items-start gap-3 max-h-max"
                                            wire:key="{{ $formation->id }}">
        ...
        <div
            ...
            <div class="text-sm md:text-base text-fg-subtext">
                @if ($formations->count() > 0)
                    <span class="text-primary"> {{ $formations->count() }}</span>
                    formation{{ $formations->count() > 1 ? 's' : '' }} <span class="hidden sm:inline">Disponible{{ $formations->count() > 1 ? 's' : '' }}</span>
                @else
                ...
                @forelse($formations as $formation)
                    <div wire:key="{{ $formation->id }}"
                        ...
                        <div class="rounded bg-bg-light aspect-video">
                            <img src="{{ asset('storage/' . $formation->path) }}" alt="{{ $formation->title }}"
