                                        ...
                                        <div class="flex-1 flex flex-col gap-2">
                                            ...
                                            <div class="flex flex-wrap gap-x-4 gap-y-2 text-xs text-fg-subtext mt-1">
                                                <div class="flex items-center gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                         fill="currentColor" class="size-3.5" viewBox="0 0 256 256">
                                                        <path
                                                            d="M128,40a96,96,0,1,0,96,96A96.11,96.11,0,0,0,128,40Zm0,176a80,80,0,1,1,80-80A80.09,80.09,0,0,1,128,216ZM173.66,90.34a8,8,0,0,1,0,11.32l-40,40a8,8,0,0,1-11.32-11.32l40-40A8,8,0,0,1,173.66,90.34Z"></path>
                                                    </svg>
                                                ...
                                                <div class="flex items-center gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                         fill="currentColor" class="size-3.5" viewBox="0 0 256 256">
                                                        <path
                                                            d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216ZM173.66,82.34a8,8,0,0,1,0,11.32l-40,40a8,8,0,0,1-11.32,0l-16-16a8,8,0,0,1,11.32-11.32L128,116.69l34.34-34.35A8,8,0,0,1,173.66,82.34Z"></path>
                                                    </svg>
                        ...
                        <div
                            ...
                            <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="168" height="164"
                                ...
                                <path
                                    ...
                                    fill="#10B981"/>
                                <circle cx="142.572" cy="121" r="24.7857" fill="#D1FAE5"
                                        stroke="#6EE7B7"/>
                                <path
                        ...
                        <div class="p-6">
                            <h2 x-data="{ showTooltip: false }" @mouseenter="showTooltip = true"
                                ...
                                <div x-show="showTooltip" x-transition:enter="transition ease-out duration-200"
                                     ...
                                     class="absolute z-50 top-full left-0 mt-1 p-2 bg-bg-light border border-border-light shadow-lg rounded-md text-sm max-w-md">
                                    {{ $formation->title }}
                                </div>
                            </h2>
                            ...
                            <div class="flex flex-wrap justify-between mt-3 mb-5 text-xs text-fg-subtext">
                                <div class="flex items-center gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                ...
                                <div class="flex items-center gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                         class="size-4" viewBox="0 0 256 256">
                                        <path
                                            d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48ZM40,64H216V96H40Zm0,48H216v80a8,8,0,0,0,.08,1.1c-1.28-.08-1.08-.1-1.08-.1H40v-81ZM78,80a6,6,0,1,1-6-6A6,6,0,0,1,78,80ZM58,80a6,6,0,1,1-6-6A6,6,0,0,1,58,80Z"></path>
                                    </svg>
