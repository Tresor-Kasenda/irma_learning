            ...
            <div class="w-full grid items-center relative pt-4">
                <div
                    ...
                    @if(count($formations) > 0)
                        <div
                            class="lg:w-1/2 lg:flex-1 flex flex-col p-4 xl:p-5 rounded-md bg-white shadow-sm shadow-gray-100/20">
                    ...
                    @else
                        <div class="lg:w-1/2 lg:flex-1">
                            <div
                                class="w-full flex flex-col items-center px-5 sm:px-10 py-8 sm:py-16 lg:py-20 lg:px-16 border border-dashed rounded-md bg-bg shadow-sm shadow-gray-100/20">
                                ...
                                <div>
                                    ...
                                    <p class="text-center text-fg text-base font-normal leading-relaxed pb-4 max-w-sm mx-auto">
