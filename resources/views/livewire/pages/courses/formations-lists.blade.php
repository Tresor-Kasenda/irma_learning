        ...
        <div class="w-full grid items-center relative pt-4">
            <div
                ...
                <div
                    ...
                    <div
                        class="text-sm pt-8 text-white flex items-center justify-center text-center divide-x divide-white/50 *:px-4 first:*:pl-0 last:*:pr-0 overflow-hidden max-w-full">
                    ...
                    <h1 class="text-white text-xl mx-auto text-center">
                        Formation Continue
                    </h1>
        ...
        <div
            ...
            <div class="text-sm md:text-base text-fg-subtext">
                @if ($trainings->count() > 0)
                    ...
                    formation{{ $trainings->count() > 1 ? 's' : '' }} <span
                        class="hidden sm:inline">Disponible{{ $trainings->count() > 1 ? 's' : '' }}</span>
                @else
