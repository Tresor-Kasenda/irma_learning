            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="md:w-3/5 p-8 text-white flex flex-col justify-center">
                                ...
                                <h4 class="text-2xl font-bold mb-2">
                                    {{ continueWatching.trackable.section.formation.title }}</h4>
                                <p class="text-primary-100 mb-4">{{ continueWatching.trackable.title }}</p>
                                <div class="mb-4">
                                    <div class="flex justify-between text-sm mb-2">
                                        <span>{{
                                                Math.round(continueWatching.progress_percentage ?? 0)
                                            }}% terminé</span>
                                    </div>
                                    <div class="w-full bg-primary-800 rounded-full h-2">
                                        <div :style="{ width: (continueWatching.progress_percentage ?? 0) + '%' }"
                                             class="bg-white h-full rounded-full"/>
                                    </div>
                                </div>
                                <div>
                                    <Link
                                        :href="route('course.player', continueWatching.trackable.section.formation.id)"
                ...
                <div v-if="myEnrollments.length > 0" class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <Link :href="route('formations-lists')"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        >
                            <div class="relative h-32 bg-gray-200">
                                ...
                                />
                                <div v-else
                                     class="flex items-center justify-center h-full bg-gradient-to-br from-primary-500 to-primary-600">
                            ...
                            <div class="p-4">
                                ...
                                <div class="mb-3">
                                    <div class="w-full bg-gray-200 rounded-full h-1.5">
                                        <div :style="{ width: (enrollment.progress_percentage ?? 0) + '%' }"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        >
                            <div class="relative h-32 bg-gray-200">
                                ...
                                />
                                <div v-else
                                     class="flex items-center justify-center h-full bg-gradient-to-br from-gray-400 to-gray-500">
                                    <svg class="w-12 h-12 text-white opacity-50" fill="none" stroke="currentColor"
                                         viewBox="0 0 24 24">
                                        <path
                                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"
                                ...
                                <div v-if="formation.is_featured" class="absolute top-2 right-2">
                                    <span
                                        class="px-2 py-1 bg-yellow-500 text-white text-xs font-bold rounded">Populaire</span>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span v-if="formation.price && formation.price > 0"
