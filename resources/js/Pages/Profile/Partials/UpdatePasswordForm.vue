    ...
    <section>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div class="flex flex-col gap-1">
                <label for="current_password" class="text-sm font-medium text-slate-200">Mot de passe actuel</label>
            ...
            <div class="flex flex-col gap-1">
                <label for="password" class="text-sm font-medium text-slate-200">Nouveau mot de passe</label>
            ...
            <div class="flex flex-col gap-1">
                <label for="password_confirmation" class="text-sm font-medium text-slate-200">Confirmer le mot de passe</label>
