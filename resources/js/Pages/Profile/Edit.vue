            ...
            <div v-if="activeTab !== 'settings'" class="mt-6">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex flex-1 items-center gap-3">
                        <span class="grid size-9 shrink-0 place-items-center rounded border border-white/10 bg-white/5 text-slate-300">
                    ...
                    <div class="inline-flex items-center gap-2 self-start rounded border border-white/10 px-3 py-1.5 text-sm text-slate-300 sm:self-auto">
                ...
                <div class="mt-4 grid place-items-center rounded-lg border border-dashed border-white/10 py-20 text-center">
