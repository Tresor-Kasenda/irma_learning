...
<template>
    <Head title="Nos certifications" />

    <PublicLayout title="Nos certifications">
        ...
        <section class="pt-32">
            <div class="mx-auto flex w-full max-w-7xl flex-col items-start gap-16 px-5 py-20 sm:px-10 lg:flex-row">
                ...
                <!-- Left column -->
                <div class="flex w-full flex-col items-center space-y-7 text-center lg:w-1/2 lg:items-start lg:py-12 lg:text-left xl:py-20">
                    <div class="flex items-center divide-x divide-gray-300 overflow-hidden text-sm text-gray-500 *:px-4 first:*:pl-0 last:*:pr-0">
                        <Link href="/" aria-label="Lien vers la page principale">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-gray-600">
                    ...
                    >
                        Decouvrir plus
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 transition duration-500 group-hover:rotate-[360deg]">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" />
                        </svg>
                    </a>
                </div>

                <!-- Right column: formations card -->
                <div class="flex max-w-4xl w-full lg:flex-1 relative before:absolute before:inset-y-3 md:before:inset-y-10 before:border-y before:border-gray-200 after:border-gray-200 before:w-full after:absolute after:inset-x-3 md:after:inset-x-10 after:border-x after:h-full">
                    <div class="relative flex w-full items-center justify-center px-4 py-6">
                        <div v-if="heroFormations.length > 0" class="relative z-10 flex w-full flex-col bg-white/80 backdrop-blur-lg border border-gray-200/30 rounded-lg shadow-sm p-6">
                            ...
                            <ul class="flex flex-col gap-4 divide-y divide-gray-100 *:py-2 first:*:pt-0 last:*:pb-0 mb-5">
                                ...
                                >
                                    <div class="flex shrink-0 rounded bg-primary-50 p-2 text-primary-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256" class="size-7">
                                    ...
                                    <div class="flex flex-1 flex-col gap-1">
                                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                                            <div class="mb-2 sm:mb-0 sm:mr-4">
                                                <h3 class="line-clamp-2 font-semibold text-gray-900">{{ formation.title }}</h3>
                                                <div class="mt-1 flex items-center gap-1.5 text-sm text-gray-500">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="size-3.5" viewBox="0 0 256 256">
                                        ...
                                        <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                                            <div class="flex items-center gap-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="size-3.5" viewBox="0 0 256 256">
                                                    <path d="M128,40a96,96,0,1,0,96,96A96.11,96.11,0,0,0,128,40Zm0,176a80,80,0,1,1,80-80A80.09,80.09,0,0,1,128,216ZM173.66,90.34a8,8,0,0,1,0,11.32l-40,40a8,8,0,0,1-11.32-11.32l40-40A8,8,0,0,1,173.66,90.34Z" />
                                                </svg>
                        ...
                        <!-- Empty state -->
                        <div v-else class="relative z-10 flex w-full flex-col items-center bg-white/80 backdrop-blur-lg border border-gray-200/30 rounded-lg shadow-sm px-6 py-12">
                ...
                <div class="grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="relative flex size-3 duration-300 ease-linear" :class="openAccordion === 0 ? 'rotate-45' : ''">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="relative flex size-3 duration-300 ease-linear" :class="openAccordion === 1 ? 'rotate-45' : ''">
                                <span class="absolute top-1/2 flex h-0.5 w-full -translate-y-1/2 bg-gray-500" />
                                <span class="absolute left-1/2 flex h-full w-0.5 -translate-x-1/2 bg-gray-500" />
                            </div>
                        </button>
                        <div v-if="openAccordion === 1" class="border-t border-gray-100 p-4">
                            ...
                            <ul class="mt-2 list-outside list-disc space-y-1 pl-5 text-sm text-gray-600">
                                <li>
                                    Entièrement automatisés et accessibles en ligne immédiatement après la fin de la MasterClass.
                                </li>
                                <li>
                    ...
                    >
                        ...
                        >
                            <h5 class="font-medium text-primary-700">Publication des Résultats et Délivrance des Certifications</h5>
                            <div class="relative flex size-3 duration-300 ease-linear" :class="openAccordion === 2 ? 'rotate-45' : ''">
                                <span class="absolute top-1/2 flex h-0.5 w-full -translate-y-1/2 bg-gray-500" />
                                <span class="absolute left-1/2 flex h-full w-0.5 -translate-x-1/2 bg-gray-500" />
                            </div>
                        </button>
                        <div v-if="openAccordion === 2" class="border-t border-gray-100 p-4">
                            <ul class="list-outside list-disc space-y-2 pl-5 text-sm text-gray-600">
                                ...
                                <li>
                                    Les certifications attestant des compétences acquises sont disponibles sous deux formats :
                                    <ul class="mt-2 list-outside list-disc space-y-2 pl-5 text-sm text-gray-600">
                                        ...
                                        <li>
                                            ...
                                            des certifications imprimées sous 5 jours ouvrables après publication des résultats.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
        ...
        <section id="certifications" class="scroll-mt-20 bg-gray-50 pb-20">
            ...
            <!-- Sticky search bar -->
            <div class="sticky top-2 z-20 mx-auto mb-8 flex h-14 w-full max-w-7xl items-center justify-between rounded-md border border-gray-200 bg-white/90 px-5 shadow-sm backdrop-blur-sm sm:px-10">
                ...
                <div class="flex w-full items-center gap-3 sm:w-auto">
                    ...
                    <div class="relative min-w-0 flex-1 sm:w-72 sm:flex-none">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-gray-400" viewBox="0 0 256 256">
                    ...
                    <div class="relative hidden sm:block">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="pointer-events-none absolute right-2 top-1/2 size-4 -translate-y-1/2 text-gray-400">
                    ...
                    <div class="relative">
                        ...
                        >
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button" class="text-xs text-primary-600 hover:text-primary-800" @click="resetFilters">
                                    Réinitialiser
                                </button>
                            </div>
                            <fieldset class="mt-4">
                        ...
                        >
                            ...
                            <div class="flex flex-1 flex-col p-6">
                                ...
                                <div v-if="parseTags(formation.tags).length > 0" class="mt-3 flex flex-wrap gap-2">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mr-1 size-3">
                                            <path fill-rule="evenodd" d="M5.5 3A2.5 2.5 0 0 0 3 5.5v2.879a2.5 2.5 0 0 0 .732 1.767l6.5 6.5a2.5 2.5 0 0 0 3.536 0l2.878-2.878a2.5 2.5 0 0 0 0-3.536l-6.5-6.5A2.5 2.5 0 0 0 8.38 3H5.5ZM6 7a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z" clip-rule="evenodd" />
                                        </svg>
                                        {{ tag }}
                                    </span>
                                </div>
