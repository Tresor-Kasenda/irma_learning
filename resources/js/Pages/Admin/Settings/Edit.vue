            ...
            <div class="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
                <div class="grid min-w-0 gap-6">
                    ...
                    <section class="admin-panel min-w-0 overflow-hidden border">
                        ...
                        <div class="grid gap-5 p-5 sm:p-6">
                            <TextField v-model="form.auth_page_subtitle" :error="form.errors.auth_page_subtitle" label="Sous-titre des pages de connexion" placeholder="Bâtissez votre avenir professionnel dans le BTP et l'Artisanat"/>
                            <TextField v-model="form.auth_login_subtitle" :error="form.errors.auth_login_subtitle" label="Texte de bienvenue (connexion)" placeholder="Connectez-vous pour accéder à votre espace de formation"/>
                            <TextField v-model="form.auth_register_subtitle" :error="form.errors.auth_register_subtitle" label="Texte d'invite (inscription)" placeholder="Créez votre compte et commencez votre parcours"/>
                        </div>
                    </section>
