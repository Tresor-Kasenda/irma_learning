        ...
        <form @submit.prevent="submit"
            ...
            <div class="p-5 sm:p-8">
                <div class="text-center">
                    <h1 class="text-gray-900 mb-1 text-xl font-semibold">Nouveau mot de passe</h1>
                    <p class="text-sm text-gray-500">Choisissez un nouveau mot de passe pour votre compte</p>
                </div>
            ...
            <div class="bg-gray-50 rounded px-5 sm:px-6 py-4">
                <p class="text-center text-sm text-gray-600">
                    Retourner à la
                    <a :href="route('login')" class="font-medium text-irma-primary hover:opacity-80">connexion</a>
                </p>
            </div>
        </form>
    </GuestLayout>
